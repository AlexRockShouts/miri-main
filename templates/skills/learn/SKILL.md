...
2. List all `.md` files in the skill directory or child directories
...
14. Check if `~/..miri` directory exists → **Miri**
   - Install path: `~/.miri/skills/<slug>.md`
...
When creating the skill directory, create it if it doesn't exist (e.g., `mkdir -p .miri/skills/`).
